...
`;
    ...
    const result = await model.respond(spec + " if prompt does not meet with demands on json do not give me json and give me why it is wrong and not as json format, else just give json only prompt: " + prompt );
